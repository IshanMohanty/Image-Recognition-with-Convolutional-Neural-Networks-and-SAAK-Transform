...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr 18 20:08:54 2018
...
def base_model():    
    ...
    model.add(Conv2D(6, kernel_size=(5, 5), strides=(1, 1), 
                     activation='sigmoid',padding='SAME', use_bias=True, kernel_initializer = 'RandomNormal'))
...
history = model.fit(X_train, y_train, validation_data=(X_valid, y_valid),
                    epochs=epochs, batch_size=batch_size, verbose=2) #,callbacks=[tensorboard])
end = time.time()
